        ...
        <main>
            <section className="tc-404-info text-center">
                <div style={{marginTop: 50}} className="container">
                    ...
                    <p className="color-777"> Sorry, the requested page could not be found. <a href="#" onClick={() => props.openNavBar(prev => true)} className="fw-bold color-000"> Try searching? </a> </p>
                    <Link
                        href="/"
