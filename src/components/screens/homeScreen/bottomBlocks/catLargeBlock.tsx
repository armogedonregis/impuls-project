        ...
        <div className="p-30 bg-white radius-7 border-0 mb-30">
            <div className="row text-uppercase fsz-14px ">
                ...
                <div className="col-lg-6 text-lg-end">
                    <Link href={`category/${props.category?.url ? props.category.url : ""}`} className="text-capitalize hover-main"> All {props.category?.name} News <i className="la la-angle-right ms-1"></i> </Link>
                </div>
            </div>
